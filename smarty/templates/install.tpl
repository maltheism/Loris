...
<div class="container">
    ...
    {if $error}
        <div class="alert alert-danger error">{$error}</div>{/if}
    {if $console}
        <div class="alert alert-warning console">
        <pre>{$console}</pre></div>{/if}
    <div>
        ...
        {else}
            ...
            <form method="post">
                ...
                <hr/>
                <div class="col-md-12">
                    <input class="btn btn-submit btn-secondary" type="submit"/>
                </div>
            </form>
        {/if}
    </div>
