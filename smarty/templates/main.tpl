...
<form action="{$FormAction}" method="post">
    ...
    <div id="wrap">
        {if $dynamictabs neq "dynamictabs"}
            <nav class="navbar navbar-light navbar-fixed-top" role="navigation" id="nav-left">
                <div class="navbar-header">
                    ...
                    <button type="button" class="navbar-toggler help-button">
                        <span class="sr-only">Toggle navigation</span>
                ...
                <div class="collapse navbar-collapse" id="example-navbar-collapse">
                    ...
                    <ul class="navbar-nav ml-auto" id="nav-right">
                        {if $bvl_feedback}
                            <li class=".d-none .d-sm-block .d-none .d-md-block">
                                <a href="#" class="navbar-toggler" data-toggle="offcanvas" data-target=".navmenu" data-canvas="body">
                        ...
                        <li class=".d-none .d-sm-block .d-none .d-md-block">
                            <a href="#" class="navbar-brand float-right help-button">
                                <img width=17 src="{$baseurl}/images/help.gif">
                            </a>
                        </li>
                        <li class="nav">
                            ...
                            <div>
                                ...
                                {else}
                                    {if $candID != ""}
                                        ...
                                        <table cellpadding="2" class="table table-table-info table-bordered dynamictable" style="max-width:auto">
                                            <!-- column headings -->
                                            <thead>
                                            <tr class="table-info">
                                                <th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-12">
                        <input class="btn btn-primary col-12" id="modal-login" name="login" type="submit" value="Login">
                    </div>
                </div>
            </div>
        </div>
