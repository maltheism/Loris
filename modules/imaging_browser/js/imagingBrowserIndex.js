  ...
  _createClass(ImagingBrowserIndex, [{
    ...
    value: function formatColumn(column, cell, row) {
      ...
      switch (column) {
        case 'New Data':
          if (cell === 'new') {
            result = _react2.default.createElement('td', { className: 'newdata' }, 'NEW');
          }
          break;
        case 'Links':
          ...
          for (var i = 0; i < cellTypes.length; i += 1) {
            cellLinks.push(_react2.default.createElement('a', { key: i, href: loris.BaseURL + '/imaging_browser/viewSession/?sessionID=' + row.SessionID + '&outputType=' + cellTypes[i] + '&backURL=/imaging_browser/' }, cellTypes[i]));
            cellLinks.push(' | ');
          }
          cellLinks.push(_react2.default.createElement('a', { key: 'selected', href: loris.BaseURL + '/imaging_browser/viewSession/?sessionID=' + row.SessionID + '&selectedOnly=1&backURL=/imaging_browser/' }, 'selected'));

          cellLinks.push(' | ');
          cellLinks.push(_react2.default.createElement('a', { key: 'all', href: loris.BaseURL + '/imaging_browser/viewSession/?sessionID=' + row.SessionID + '&backURL=/imaging_browser/' }, 'all types'));
          result = _react2.default.createElement('td', null, cellLinks);
          break;
      }
...
/******/ });
//# sourceMappingURL=imagingBrowserIndex.js.map