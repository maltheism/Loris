    ...
    <div class="col-lg-8">
        ...
        <div class="card card-default">
            <div class="card-body">
                ...
                <p class="float-right small login-time">Last login: {$last_login}</p>
        ...
        <div class="card card-default">
            <div class="card-header">
                ...
                <span class="float-right clickable glyphicon glyphicon-chevron-up"></span>
            ...
            <div class="card-body">
                <div class="recruitment-card" id="overall-recruitment">
                    {include file='progress_bar.tpl' project=$recruitment["overall"]}
                </div>
                <div class="recruitment-card hidden" id="recruitment-site-breakdown">
                ...
                {if $useProjects eq "true"}
                    <div class="recruitment-card hidden" id="recruitment-project-breakdown">
        ...
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">Study Progression</h3>
                <span class="float-right clickable glyphicon glyphicon-chevron-up"></span>
                <div class="float-right">
                    <div class="btn-group views">
                        <button type="button" class="btn btn-secondary btn-sm dropdown-toggle" data-toggle="dropdown">
    ...
    <div class="col-lg-4">
                            ...
                            {if $conflicts neq "" and $conflicts neq 0}
                                <a href="{$baseURL}/conflict_resolver/" class="list-group-item conflict_resolver">
                                    <div class="row">
                                        ...
                                        <div class="col-4 text-right alert-chevron">
        ...
        {if $document_repository_notifications neq ""}
            <div class="col-lg-12 col-md-6 col-sm-6 col-12">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Document Repository Notifications</h3>
                        <span class="float-right clickable glyphicon glyphicon-chevron-up"></span>
                    </div>
                    <!-- /.panel-heading -->
                    <div class="card-body">
                            ...
                            {foreach from=$document_repository_notifications item=link}
                                <a href="AjaxHelper.php?Module=document_repository&script=GetFile.php&File={$link.Data_dir}"
                                   download="{$link.File_name}" class="list-group-item">
                                    {if $link.new eq 1}
                                        <span class="float-left new-flag">NEW</span>
                                    {/if}
                                    <span class="float-right text-muted small">Uploaded: {$link.Date_uploaded}</span>
                                    <br>
                                    {$link.File_name}
                                </a>
                            {/foreach}
                        ...
                        <!-- /.list-group -->
                        <a href="{$baseURL}/document_repository/" class="btn btn-secondary btn-block">Document Repository
        ...
        {if $bvl_feedback_notifications neq ""}
            <div class="col-lg-12 col-md-6 col-sm-6 col-12">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Behavioural Feedback Notifications</h3>
                        <span class="float-right clickable glyphicon glyphicon-chevron-up"></span>
                    </div>
                    <!-- /.panel-heading -->
                    <div class="card-body">
                            ...
                            {foreach from=$bvl_feedback_notifications item=link}
                                <a href="{$baseURL}{$link.URL}" class="list-group-item">
                                    {if $link.new eq 1}
                                        <span class="float-left new-flag">NEW</span>
                                    {/if}
                                    <span class="float-right text-muted small">Updated: {$link.Testdate}</span>
                                    <br>
