 ...
 *
 * */
var HelpEditor = function (_React$Component) {
  _inherits(HelpEditor, _React$Component);

  function HelpEditor(props) {
    _classCallCheck(this, HelpEditor);

    var _this = _possibleConstructorReturn(this, (HelpEditor.__proto__ || Object.getPrototypeOf(HelpEditor)).call(this, props));
  ...
  _createClass(HelpEditor, [{
    ...
    value: function formatColumn(column, cell, row) {
      ...
      switch (column) {
        case 'Topic':
          ...
          result = React.createElement('td', null, React.createElement('a', { href: url }, cell));
          break;
        case 'Parent Topic':
    ...
    value: function render() {
      ...
      var fields = [{ label: 'Help ID', show: false }, { label: 'Topic', show: true, filter: {
          name: 'topic',
          type: 'text'
        } }, { label: 'Parent ID', show: false }, { label: 'Parent Topic ID', show: false }, { label: 'Parent Topic', show: true }, { label: 'Content', show: true, filter: {
          name: 'content',
          type: 'text'
        } }];

      return React.createElement(_FilterableDataTable2.default, {
        name: 'help_filter',
        data: data,
        fields: fields,
