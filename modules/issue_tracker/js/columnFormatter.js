...
function formatColumn(column, cell, rowData, rowHeaders) {
  ...
  if (column === 'PSCID' && row.PSCID !== null) {
    var _cellLinks2 = [];
    _cellLinks2.push(React.createElement(
      'a',
  ...
  if (column === 'Visit Label' && row['Visit Label'] !== null) {
    var _cellLinks3 = [];
    _cellLinks3.push(React.createElement(
      'a',
