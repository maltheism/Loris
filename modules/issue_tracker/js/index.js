    ...
    value: function render() {
      ...
      var history = Object.keys(changes).sort().reverse().map(function (key, i) {
        var textItems = Object.keys(changes[key]).map(function (index, j) {
          return _react2.default.createElement('div', { key: j, className: 'row' }, _react2.default.createElement('div', { className: 'col-md-2' }, _react2.default.createElement('div', { className: 'col-md-8' }, _react2.default.createElement('b', null, index)), _react2.default.createElement('div', { className: 'col-md-4' }, ' to ')), _react2.default.createElement('div', { className: 'col-md-10' }, _react2.default.createElement('i', null, changes[key][index])));
        }, this);

        return _react2.default.createElement('div', { key: i }, _react2.default.createElement('hr', null), _react2.default.createElement('div', { className: 'history-item-label' }, _react2.default.createElement('span', null, key), ' updated :'), _react2.default.createElement('div', { className: 'history-item-changes' }, textItems));
      }, this);

      return _react2.default.createElement('div', null, _react2.default.createElement('div', { className: 'btn btn-primary',
        onClick: this.toggleCollapsed,
        'data-toggle': 'collapse',
        'data-target': '#comment-history',
        style: { margin: '10px 0' }
      }, btnCommentsLabel), _react2.default.createElement('div', { id: 'comment-history', className: 'collapse' }, history));
    }
  }]);
...
var _CommentList = __webpack_require__(/*! ./CommentList */ "./modules/issue_tracker/jsx/CommentList.js");
...
var IssueForm = function (_Component) {
  ...
  _createClass(IssueForm, [{
    ...
    value: function render() {
      ...
      var lastUpdateValue = void 0;
      var lastUpdatedByValue = void 0;
      var dateCreated = void 0;
      var submitButtonValue = void 0;
      var commentLabel = void 0;
      ...
      var commentHistory = this.state.isNewIssue || _react2.default.createElement(_CommentList2.default, { commentHistory: this.state.issueData.commentHistory });

      var header = void 0;
      var description = void 0;
      if (!this.state.isNewIssue) {
        header = _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-md-6' }, _react2.default.createElement(StaticElement, {
          name: 'lastUpdate',
          label: 'Last Update: ',
          ref: 'lastUpdate',
          text: lastUpdateValue
        })), _react2.default.createElement('div', { className: 'col-md-6' }, _react2.default.createElement(StaticElement, {
          name: 'lastUpdatedBy',
        ...
        description = _react2.default.createElement(StaticElement, {
          name: 'description',
          label: 'Description',
          ref: 'description',
      ...
      return _react2.default.createElement('div', null, _react2.default.createElement(FormElement, {
        ...
        ref: 'form'
      }, _react2.default.createElement('h3', null, headerText), header, _react2.default.createElement(TextboxElement, {
        name: 'title',
        label: 'Title',
        ...
        required: true
      }), description, _react2.default.createElement(SelectElement, {
        name: 'assignee',
        label: 'Assignee',
        emptyOption: true,
      ...
      }), _react2.default.createElement(ButtonElement, { label: submitButtonValue })), commentHistory);
    }
...
var _IssueForm = __webpack_require__(/*! ./IssueForm */ "./modules/issue_tracker/jsx/IssueForm.js");
...
$(function () {
  ...
  var issueTracker = React.createElement("div", { className: "page-issue-tracker" }, React.createElement(_IssueForm2.default, {
