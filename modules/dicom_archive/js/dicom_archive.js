        ...
        case 'Archive Location':
          {
            ...
            result = _react2.default.createElement('td', null, _react2.default.createElement('a', { href: downloadURL }, _react2.default.createElement('span', { className: 'glyphicon glyphicon-cloud-download' }), '\xA0', cell));
          }
          break;
        case 'Metadata':
          {
            var metadataURL = loris.BaseURL + '/dicom_archive/viewDetails/?tarchiveID=' + row.TarchiveID;
            result = _react2.default.createElement('td', null, _react2.default.createElement('a', { href: metadataURL }, cell));
          }
          break;
        case 'MRI Browser':
          {
            if (row.SessionID === null || row.SessionID === '') {
              result = _react2.default.createElement('td', null, '\xA0');
            } else {
              var mrlURL = loris.BaseURL + '/imaging_browser/viewSession/?sessionID=' + row.SessionID;
              result = _react2.default.createElement('td', null, _react2.default.createElement('a', { href: mrlURL }, cell));
            }
            break;
          }
        case 'INVALID - HIDDEN':
          result = _react2.default.createElement('td', { className: 'text-danger' }, cell);
          break;
      }
