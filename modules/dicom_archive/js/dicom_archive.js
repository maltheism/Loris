 ...
 *
 * */
var DicomArchive = function (_Component) {
  ...
  _createClass(DicomArchive, [{
        ...
        case 'Archive Location':
          {
            ...
            result = _react2.default.createElement(
              ...
              _react2.default.createElement(
                'a',
                { href: downloadURL },
                _react2.default.createElement('span', { className: 'glyphicon glyphicon-cloud-download' }),
                '\xA0',
                cell
              )
            );
    ...
    value: function render() {
      ...
      var fields = [{ label: 'Patient ID', show: true, filter: {
          name: 'patientID',
          type: 'text'
          ...
          type: 'text'
        } }, { label: 'Metadata', show: true }, { label: 'MRI Browser', show: true }, { label: 'Series UID', show: false, filter: {
          name: 'seriesUID',
          type: 'text'
        ...
        } }, { label: 'TarchiveID', show: false }, { label: 'SessionID', show: false }];
...
window.addEventListener('load', function () {
  ReactDOM.render(_react2.default.createElement(DicomArchive, { dataURL: loris.BaseURL + '/dicom_archive/?format=json' }), document.getElementById('lorisworkspace'));
});
