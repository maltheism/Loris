...
var ExaminerIndex = function (_Component) {
  ...
  _createClass(ExaminerIndex, [{
      ...
      switch (column) {
        ...
        case 'Radiologist':
          if (row.Radiologist === '1') {
            result = _react2.default.createElement('td', null, 'Yes');
          } else if (row.Radiologist === '0') {
            result = _react2.default.createElement('td', null, 'No');
          }
          break;
        case 'Certification':
          if (row.Certification === null) {
            result = _react2.default.createElement('td', null, 'None');
          }
          break;
      }
      return result;
    ...
    value: function renderAddExaminerForm() {
      return _react2.default.createElement(_Modal2.default, {
      ...
      }, _react2.default.createElement(FormElement, {
        Module: 'examiner',
        name: 'addExaminer',
        id: 'addExaminerForm',
        ...
        name: 'fire_away',
        label: _react2.default.createElement('div', null, _react2.default.createElement('span', { className: 'glyphicon glyphicon-plus' }), ' Add'),
        type: 'submit',
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', null, this.renderAddExaminerForm(), _react2.default.createElement(_FilterableDataTable2.default, {
        name: 'examiner',
        title: 'Examiner',
...
/******/ });
//# sourceMappingURL=examinerIndex.js.map