...
var InstrumentManagerIndex = function (_Component) {
  ...
  _createClass(InstrumentManagerIndex, [{
    ...
    value: function formatColumn(column, cell, row) {
      return _react2.default.createElement('td', null, cell);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var feedback = function feedback() {
        if (!_this4.state.data.caninstall) {
          return _react2.default.createElement('div', { className: 'alert alert-warning' }, 'Instrument installation is not possible given the current server configuration; the LORIS \'quatUser\' is not configured properly. File upload is still possible but instruments will need to be installed manually');
        }
      };
      ...
      var uploadTab = function uploadTab() {
        ...
        if (_this4.state.data.writable) {
          ...
          content = _react2.default.createElement('div', { className: 'alert alert-warning' }, 'Installation is not possible given the current server configuration. Please contact your administrator if you require this functionality');
        }
        return content;
      };
      ...
      })), _react2.default.createElement(_Tabs.TabPane, { TabId: 'upload' }, feedback(), uploadTab()));
    }
  }]);
...
var InstrumentUploadForm = function (_Component) {
  ...
  _createClass(InstrumentUploadForm, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-xs-4' }, _react2.default.createElement('div', { className: 'panel panel-primary' }, _react2.default.createElement('div', { className: 'panel-heading' }, 'Upload Instrument'), _react2.default.createElement('div', { className: 'panel-body' }, _react2.default.createElement('div', { className: 'col-xs-12' }, _react2.default.createElement(FileElement, {
        name: 'install_file',
        label: 'Instrument file',
        onUserInput: this.fileSelected,
        value: this.state.selectedFile
      }), _react2.default.createElement('button', { className: 'btn btn-default', onClick: this.upload, disabled: disabled() }, 'Install'))))));
    }
  }]);
...
/******/ });
//# sourceMappingURL=instrumentManagerIndex.js.map