  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      ...
      if (this.props.data === null || this.props.data.length === 0) {
        return _react2.default.createElement('div', { className: 'alert alert-info no-result-found-panel' }, _react2.default.createElement('strong', null, 'No result found.'));
      }
      var rowsPerPage = this.state.RowsPerPage;
      var headers = this.state.Hide.defaultColumn === true ? [] : [_react2.default.createElement('th', { key: 'th_col_0', onClick: this.setSortColumn(-1).bind(this) }, this.props.RowNumLabel)];

      for (var i = 0; i < this.props.fields.length; i += 1) {
        if (this.props.fields[i].show === true) {
          var colIndex = i + 1;
          if (this.props.fields[i].freezeColumn === true) {
            headers.push(_react2.default.createElement('th', { key: 'th_col_' + colIndex, id: this.props.freezeColumn,
              onClick: this.setSortColumn(i).bind(this) }, this.props.fields[i].label));
          } else {
            headers.push(_react2.default.createElement('th', { key: 'th_col_' + colIndex, onClick: this.setSortColumn(i).bind(this) }, this.props.fields[i].label));
          }
        }
      }
      var rows = [];
      ...
      var _loop = function _loop(_i) {
        ...
        for (var j = 0; j < _this2.props.fields.length; j += 1) {
          ...
          if (_this2.props.getFormattedCell) {
            ...
            curRow.push(_react2.default.createElement('td', { key: key }, data));
          }
        }
        ...
        if (filterLength === filterMatchCount && (useKeyword === true && keywordMatch > 0 || useKeyword === false && keywordMatch === 0)) {
          ...
          if (matchesFound > currentPageRow) {
            ...
            rows.push(_react2.default.createElement('tr', { key: 'tr_' + rowIndex, colSpan: headers.length }, _react2.default.createElement('td', null, rowIndex), curRow));
          }
        }
      };
      ...
      var RowsPerPageDropdown = _react2.default.createElement('select', {
        className: 'input-sm perPage',
        onChange: this.changeRowsPerPage,
        value: this.state.RowsPerPage
      }, _react2.default.createElement('option', null, '20'), _react2.default.createElement('option', null, '50'), _react2.default.createElement('option', null, '100'), _react2.default.createElement('option', null, '1000'), _react2.default.createElement('option', null, '5000'), _react2.default.createElement('option', null, '10000'));
      ...
      var header = this.state.Hide.rowsPerPage === true ? '' : _react2.default.createElement('div', { className: 'table-header' }, _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-xs-12' }, _react2.default.createElement('div', null, rows.length, ' rows displayed of ', filteredRows, '. (Maximum rows per page: ', RowsPerPageDropdown, ')'), _react2.default.createElement('div', { className: 'pull-right', style: { marginTop: '-43px' } }, this.renderActions(), _react2.default.createElement('button', {
        className: 'btn btn-primary',
        onClick: this.downloadCSV.bind(null, csvData)
      }, 'Download Table as CSV'), _react2.default.createElement(_PaginationLinks2.default, {
        Total: filteredRows,
      ...
      var footer = this.state.Hide.downloadCSV === true ? '' : _react2.default.createElement('div', null, _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-xs-12', style: { marginTop: '10px' } }, _react2.default.createElement('div', { className: 'footerText' }, rows.length, ' rows displayed of ', filteredRows, '. (Maximum rows per page: ', RowsPerPageDropdown, ')'), _react2.default.createElement('div', { className: 'pull-right', style: { marginTop: '-23px' } }, _react2.default.createElement(_PaginationLinks2.default, {
        Total: filteredRows,
        onChangePage: this.changePage,
        RowsPerPage: rowsPerPage,
        Active: this.state.PageNumber
...
var Filter = function (_Component) {
  ...
  _createClass(Filter, [{
    ...
    key: 'render',
    value: function render() {
      return _react2.default.createElement(FormElement, {
        id: this.props.id,
        name: this.props.name
      }, _react2.default.createElement(FieldsetElement, {
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      var submitButton = function submitButton() {
        if (onSubmit) {
          return _react2.default.createElement('div', { style: submitStyle }, _react2.default.createElement(ButtonElement, {
            label: 'Submit',
      ...
      return _react2.default.createElement('div', { style: modalContainer, onClick: this.handleClose }, _react2.default.createElement('div', {
        style: modalContent,
        onClick: function onClick(e) {
          return e.stopPropagation();
        }
      }, _react2.default.createElement('div', { style: headerStyle }, title, _react2.default.createElement('span', { style: glyphStyle, onClick: this.handleClose }, '\xD7')), _react2.default.createElement('div', { style: bodyStyle }, renderChildren()), _react2.default.createElement('div', { style: footerStyle }, submitButton())));
    }
  }]);
...
var PaginationLinks = function (_Component) {
  ...
  _createClass(PaginationLinks, [{
    ...
    value: function render() {
      ...
      if (startPage > 1) {
        pageLinks.push(_react2.default.createElement('li', { key: 'table_page_beginning_' + startPage.toString(), onClick: this.changePage(1) }, _react2.default.createElement('a', { href: '#' }, '\xAB')));
      }
      if (startPage < 1) {
        startPage = 1;
      }
      ...
      for (var i = startPage; i <= lastShownPage; i += 1) {
        ...
        pageLinks.push(_react2.default.createElement('li', { key: 'table_page_' + i.toString(), onClick: this.changePage(i), className: classList }, _react2.default.createElement('a', { href: '#' }, i)));
      }
      if (lastShownPage !== lastPage) {
        pageLinks.push(_react2.default.createElement('li', { key: 'table_page_more_' + lastShownPage.toString(), onClick: this.changePage(lastPage) }, _react2.default.createElement('a', { href: '#' }, '\xBB')));
      }

      return _react2.default.createElement('ul', { className: 'pagination pagination-table' }, pageLinks);
    }
  }]);
...
var Panel = function (_Component) {
  ...
  _createClass(Panel, [{
    ...
    value: function render() {
      ...
      var panelHeading = this.props.title ? _react2.default.createElement('div', {
        className: 'panel-heading',
        onClick: this.toggleCollapsed,
        'data-toggle': 'collapse',
        'data-target': '#' + this.props.id,
        style: { cursor: 'pointer' }
      }, this.props.title, _react2.default.createElement('span', { className: glyphClass })) : '';

      return _react2.default.createElement('div', { className: 'panel panel-primary' }, panelHeading, _react2.default.createElement('div', { id: this.props.id, className: this.panelClass, role: 'tabpanel' }, _react2.default.createElement('div', { className: 'panel-body', style: { height: this.props.height } }, this.props.children)));
    }
  }]);
...
var ProgressBar = function (_Component) {
  ...
  _createClass(ProgressBar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'progress', style: progressStyle }, _react2.default.createElement('div', {
      ...
      }), _react2.default.createElement('span', { style: labelStyle }, this.props.value, '%'));
    }
  }]);
...
var Tabs = function (_Component) {
  ...
  _createClass(Tabs, [{
    ...
    value: function getTabs() {
      var tabs = this.props.tabs.map(function (tab) {
        ...
        return _react2.default.createElement('li', {
          ...
          className: tabClass,
          key: tab.id
        }, _react2.default.createElement('a', { id: tabID,
          href: href,
          role: 'tab',
          'data-toggle': 'tab',
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', null, _react2.default.createElement('ul', { className: 'nav nav-tabs', role: 'tablist', style: tabStyle }, tabs), _react2.default.createElement('div', { className: 'tab-content' }, tabPanes));
    }
  }]);
...
var VerticalTabs = function (_Component2) {
  ...
  _createClass(VerticalTabs, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', null, _react2.default.createElement('div', { className: 'tabbable col-md-3 col-sm-3' }, _react2.default.createElement('ul', { className: 'nav nav-pills nav-stacked', role: 'tablist', style: tabStyle }, tabs)), _react2.default.createElement('div', { className: 'tab-content col-md-9 col-sm-9' }, tabPanes));
    }
  }]);
...
var TabPane = function (_Component3) {
  ...
  _createClass(TabPane, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { role: 'tabpanel', className: classList, id: this.props.TabId }, title, this.props.children);
    }
  }]);
...
var TriggerableModal = function (_Component) {
  ...
  _createClass(TriggerableModal, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', null, trigger, _react2.default.createElement(_Modal2.default, _extends({}, this.props, { show: this.state.open, onClose: this.close })));
    }
  }]);
  ...
  _createClass(MediaEditForm, [{
    ...
    value: function render() {
      ...
      if (this.state.error !== undefined) {
        return _react2.default.createElement('div', { className: 'alert alert-danger text-center' }, _react2.default.createElement('strong', null, this.state.error));
      }

      // Waiting for data to load
      if (!this.state.isLoaded) {
        return _react2.default.createElement('button', { className: 'btn-info has-spinner' }, 'Loading', _react2.default.createElement('span', {
          className: 'glyphicon glyphicon-refresh glyphicon-refresh-animate' }));
      }

      return _react2.default.createElement('div', null, _react2.default.createElement(FormElement, {
        name: 'mediaEdit',
...
var MediaIndex = function (_Component) {
  ...
  _createClass(MediaIndex, [{
    ...
    value: function formatColumn(column, cell, row) {
      ...
      var result = _react2.default.createElement('td', { className: style }, cell);
      switch (column) {
        case 'File Name':
          if (this.props.hasPermission('media_write')) {
            ...
            result = _react2.default.createElement('td', { className: style }, _react2.default.createElement('a', { href: downloadURL, target: '_blank', download: row['File Name'] }, cell));
          }
          break;
        case 'Visit Label':
          if (row['CandID'] !== null && row['SessionID']) {
            var sessionURL = loris.BaseURL + '/instrument_list/?candID=' + row['CandID'] + '&sessionID=' + row['SessionID'];
            result = _react2.default.createElement('td', { className: style }, _react2.default.createElement('a', { href: sessionURL }, cell));
          }
          break;
        case 'Edit Metadata':
          var editButton = _react2.default.createElement(_TriggerableModal2.default, { title: 'Edit Media File', label: 'Edit' }, _react2.default.createElement(_editForm2.default, {
          ...
          result = _react2.default.createElement('td', { className: style }, editButton);
          break;
      }
    ...
    value: function render() {
      ...
      if (this.state.error) {
        return _react2.default.createElement('h3', null, 'An error occured while loading the page.');
      }
      ...
      var uploadTab = function uploadTab() {
        if (_this4.props.hasPermission('media_write')) {
          ...
          return _react2.default.createElement(_Tabs.TabPane, { TabId: tabs[1].id }, _react2.default.createElement(_uploadForm2.default, {
      ...
      return _react2.default.createElement(_Tabs.Tabs, { tabs: tabs, defaultTab: 'browse', updateURL: true }, _react2.default.createElement(_Tabs.TabPane, { TabId: tabs[0].id }, _react2.default.createElement(_FilterableDataTable2.default, {
        name: 'media',
...
var MediaUploadForm = function (_Component) {
  ...
  _createClass(MediaUploadForm, [{
    ...
    value: function render() {
      ...
      var helpText = _react2.default.createElement('span', null, 'File name must begin with ', _react2.default.createElement('b', null, '[PSCID]_[Visit Label]_[Instrument]'), _react2.default.createElement('br', null), 'For example, for candidate ', _react2.default.createElement('i', null, 'ABC123'), ', visit ', _react2.default.createElement('i', null, 'V1'), ' for', _react2.default.createElement('i', null, 'Body Mass Index'), ' the file name should be prefixed by:', _react2.default.createElement('b', null, ' ABC123_V1_Body_Mass_Index'), _react2.default.createElement('br', null), 'File cannot exceed ', this.props.maxUploadSize);

      return _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-md-8 col-lg-7' }, _react2.default.createElement(FormElement, {
        name: 'mediaUpload',
        fileUpload: true,
        onSubmit: this.handleSubmit,
        ref: 'form'
      }, _react2.default.createElement('h3', null, 'Upload a media file'), _react2.default.createElement('br', null), _react2.default.createElement(StaticElement, {
        label: 'Note',
        text: helpText
      }), _react2.default.createElement(SelectElement, {
        name: 'pscid',
      ...
      }), _react2.default.createElement(ButtonElement, { label: 'Upload File' }), _react2.default.createElement('div', { className: 'row' }, _react2.default.createElement('div', { className: 'col-sm-9 col-sm-offset-3' }, _react2.default.createElement(_ProgressBar2.default, { value: this.state.uploadProgress }))))));
    }
