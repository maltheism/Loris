...
var DataIntegrityFlagIndex = function (_Component) {
  ...
  _createClass(DataIntegrityFlagIndex, [{
    ...
    value: function formatColumn(column, cell, row) {
      var result = _react2.default.createElement('td', null, cell);
      switch (column) {
        case 'Instrument':
          var url = loris.BaseURL + '/data_team_helper/?visit_label=' + row['Visit Label'] + '&instrument=' + row.Instrument;
          result = _react2.default.createElement('td', null, _react2.default.createElement('a', { href: url }, cell));
          break;
        case 'Flag Status':
          var statusList = this.state.data.fieldOptions.flagStatusList;
          if (Object.keys(statusList).length > 0 && statusList[cell]) {
            result = _react2.default.createElement('td', null, statusList[cell]);
          }
          break;
      }
    ...
    value: function render() {
      ...
      })), _react2.default.createElement(_Tabs.TabPane, { TabId: tabs[1].id }, _react2.default.createElement(_setFlagForm2.default, {
...
var SetFlagForm = function (_Component) {
  ...
  _createClass(SetFlagForm, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'col-md-8 col-lg-6' }, _react2.default.createElement(FormElement, { name: 'flag_form', onSubmit: this.handleSubmit }, _react2.default.createElement('h3', { className: 'text-center' }, 'Update Instrument Status'), _react2.default.createElement('br', null), _react2.default.createElement(SelectElement, {
        name: 'visitLabel',
        label: 'Visit Label',
        ...
        label: 'Comment',
        onUserInput: this.setFormData,
        value: this.state.formData.comment }), _react2.default.createElement(ButtonElement, { label: 'Update' })));
    }
  }]);
...
/******/ });
//# sourceMappingURL=dataIntegrityFlagIndex.js.map